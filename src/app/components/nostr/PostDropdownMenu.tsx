...
export default function PostDropdownMenu() {
  ...
  return (
    <div ref={dropdownRef}>
      ...
      <div
        className={`absolute z-50 mt-[10px] rounded-[10px] w-[200px] bg-veryDarkGray border border-darkPurple hover:border-selectedPurple transition ease-in-out duration-200 dropdown-menu ${
