  ...
  return (
    <div ref={dropdownRef}>
      <div className="relative">
        ...
        <div
          className={`absolute z-20 mt-[10px] rounded-[10px] w-[200px] bg-black border border-gray-800 hover:border-gray-700 shadow-md hover:shadow-lg shadow-white/10 hover:shadow-white/10 transition ease-in-out duration-200 ${
            openPostDropdownMenu ? "block" : "hidden"
          } ${viewportWidth < 930 ? "right-0" : "left-0"}`}
          style={{ top: "100%" }}
        >
