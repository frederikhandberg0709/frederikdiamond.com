...
const ProfileFeed: React.FC<ProfileFeedProps> = ({
  ...
  const filterEvents = (events: any[]) => {
    return events.filter((event) => {
      ...
      if (filterType === "text" && images.length === 0 && videos.length === 0) return true;
  ...
  const renderMedia = ({ images, videos }: { images: string[], videos: string[] }) => {
          ...
          {filterEvents(events)
              ...
              .map((event) => {
                ...
                return (
                  ...
                  >
                    <div
                        className="flex flex-col gap-[10px] sm:w-[600px] w-[90%] sm:border border-gray-900 hover:border-gray-800 transition duration-200 bg-black sm:p-[15px] sm:rounded-[15px]">
                      {/* Author */}
                      ...
                      {/* Text content */}
                      <div className="text-[15px] leading-normal overflow-x-hidden">
