      ...
      <div className="flex flex-col gap-[40px]">
        <div className="flex flex-col gap-[15px]">
          <div className="flex gap-[20px]">
            ...
            <Image src={ArrowIcon} alt="Arrow" height={11} />
          </div>
          <p className="text-[15px] opacity-75">
            I hope that we will reach a future where the digital world becomes a
            cypherpunk utopia. Right now, we are very far from that. Big Tech
            controls almost all of the digital world. The truth is, that most
            privacy preserving products suck. The user experience is just
            ...
            space. I mean, how many privacy tools do you hear about generating a
            huge profit big enough to hire talented developers? Not many. Most
            are run by passionate developers who work on those projects in their
            spare time as hobbies — not fulltime jobs.
            <br />
            <br />
            I am not saying you cannot make a profitable business by making open
            source software. I think Proton, Red Hat, MongoDB, etc., are great
            examples showing that it really is possible to create a business
            that generates revenue even though their products are fully or
            partly open source.
            <br />
        ...
        <div className="flex flex-col gap-[15px]">
          ...
          <p className="text-[15px] opacity-75">
            ...
            huge disadvantage when you are up against State powers and companies
            (i.e. Chainalysis) who are doing everything they can to track every
            ...
            have in their wallets? Well, that{"'"}s not possible on Monero. The
            senders address is hidden by ring signatures, stealth addresses hide
            the receivers address and transaction amounts are also hidden on the
            network. Not to mention, even the amounts of Monero held in a wallet
            ...
            bullish on Monero compared to other privacy coins, is because of the
            strong community behind it. Monero is getting updated quite
