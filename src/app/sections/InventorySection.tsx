  ...
  return (
    <div>
      <div className="flex items-center gap-[20px] relative">
        <span className="absolute z-[1] font-black text-[25px] text-black max-[924px]:bottom-[70px] min-[925px]:left-[-50px]">
          04
        </span>
        <span className="font-black text-[25px] opacity-50 text-stroke-2 text-stroke-white text-fill-black absolute max-[924px]:bottom-[70px] min-[925px]:left-[-50px]">
          04
        </span>
